                ...
                <div class="container mt-5">
                    ...
                    <form id="updateForm" action="update_product" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="productBrand" name="productBrand" value="${product.thuong_hieu}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img src="./assets/img/${product.link_anh}" alt="Product Image" class="img-thumbnail mb-2" style="max-width: 200px;">
                            <input type="text" class="form-control-file" id="productImage" value="${product.link_anh}" name="productImage" readonly>
