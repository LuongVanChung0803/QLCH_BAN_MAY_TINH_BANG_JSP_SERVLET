...
<!--                    <li class="nav-item">
            ...
            <div class="content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex">
                         <form action="searchDKH" method="get">
              <input class="form-control mr-2"  placeholder="search " aria-label="search" type="text" id="search" name="search"   >
              </form>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-warning btn-sm edit"><a href="update_oder?id=${order.id_donhang}">Update</button>
                                         <button class="btn btn-warning btn-sm "><a href="InvoiceServlet?id=${order.id_donhang}">Invoice</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
